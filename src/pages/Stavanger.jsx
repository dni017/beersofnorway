// src/pages/Stavanger.jsx
// Detaljside for Stavanger - viser utesteder med ølutvalg
import { useNavigate } from 'react-router-dom'
import olKartImg from '../assets/øl-kart.png'
import '../App.css'

// Utesteder i Stavanger - legg til flere her etterhvert
const UTESTEDER = [
  {
    id: 1,
    navn: 'Cardinal',
    type: 'Pub',
    beskrivelse: 'En av Stavangers mest kjente puber med stort utvalg og god stemning.',
    antallOl: 25,
    prisKonservativ: 95,
    prisDyr: 138,
  },
  {
    id: 2,
    navn: 'Gaffel og Karaffel',
    type: 'Ølbar',
    beskrivelse: 'Hyggelig ølbar med fokus på norske og belgiske spesialøl.',
    antallOl: 55,
    prisKonservativ: 98,
    prisDyr: 145,
  },
  {
    ...
    navn: 'Sjøhuset',
    type: 'Bar',
    beskrivelse: 'Bar ved sjøkanten med godt ølutvalg og flott utsikt over Stavanger havn.',
    antallOl: 18,
    prisKonservativ: 100,
    prisDyr: 148,
  },
    ...
    >
      ...
      <section style={{ maxWidth: '1200px', margin: '0 auto 2.5rem' }}>
        ...
        <h1 style={{ marginTop: '1rem', fontSize: 'clamp(2rem, 3.3vw, 3.1rem)', color: 'var(--text-main)' }}>
          Utesteder i Stavanger
        </h1>
        <p style={{ color: 'var(--text-soft)', marginTop: '0.75rem', fontSize: '1.02rem' }}>
          Oversikt over puber og barer med ølutvalg i Stavanger sentrum.
        </p>
      </section>
