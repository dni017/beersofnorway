// src/pages/Oslo.jsx
// Detaljside for Oslo - viser utesteder med ølutvalg
import { useNavigate } from 'react-router-dom'
import olKartImg from '../assets/øl-kart.png'
import '../App.css'

// Utesteder i Oslo - legg til flere her etterhvert
const UTESTEDER = [
  {
    id: 1,
    navn: 'Crow Bar',
    type: 'Ølbar',
    beskrivelse: 'Oslos mest kjente craft beer-bar med over 20 øl på fat og hundrevis på flaske.',
    antallOl: 120,
    prisKonservativ: 105,
    prisDyr: 160,
  },
  {
    id: 2,
    navn: 'Internasjonalen',
    type: 'Pub',
    beskrivelse: 'Historisk pub på Youngstorget med god stemning og bredt ølutvalg.',
    antallOl: 30,
    prisKonservativ: 98,
    prisDyr: 140,
  },
  {
    id: 3,
    navn: 'Grünerløkka Brygghus',
    type: 'Bryggeri',
    beskrivelse: 'Lokalt mikrobryggeri på Løkka med egenproduserte øl rett fra tappekranene.',
    antallOl: 12,
    prisKonservativ: 95,
    prisDyr: 135,
  },
    ...
    >
      ...
      <section style={{ maxWidth: '1200px', margin: '0 auto 2.5rem' }}>
        ...
        <p style={{ color: 'var(--text-soft)', marginTop: '0.75rem', fontSize: '1.02rem' }}>
          Oversikt over puber og barer med ølutvalg i Oslo sentrum.
        </p>
      </section>
