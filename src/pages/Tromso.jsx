...
// Utesteder i Tromsø - legg til flere her etterhvert
const UTESTEDER = [
  {
    id: 1,
    navn: 'Ølhallen',
    type: 'Ølbar',
    beskrivelse: 'Tromsøs eldste pub med et bredt utvalg av norske og internasjonale øl.',
    antallOl: 60,
    prisKonservativ: 99,
    prisDyr: 145,
  },
  {
    ...
    navn: 'Skarven',
    type: 'Pub',
    beskrivelse: 'Populær pub i sentrum med god stemning og lokalt ølutvalg.',
    antallOl: 20,
    prisKonservativ: 95,
    prisDyr: 130,
  },
  {
    ...
    navn: 'Blå Rock Cafe',
    type: 'Bar',
    beskrivelse: 'Rock-bar med levende musikk og variert øl på fat og flaske.',
    antallOl: 15,
    prisKonservativ: 90,
    prisDyr: 120,
  },
