// src/pages/Kristiansand.jsx
// Detaljside for Kristiansand - viser utesteder med ølutvalg
import { useNavigate } from 'react-router-dom'
import olKartImg from '../assets/øl-kart.png'
import '../App.css'

// Utesteder i Kristiansand - legg til flere her etterhvert
const UTESTEDER = [
  {
    id: 1,
    navn: 'Sjøsiden',
    type: 'Bar',
    beskrivelse: 'Populær bar ved havnen med godt ølutvalg og fin utsikt.',
    antallOl: 20,
    prisKonservativ: 90,
    prisDyr: 130,
  },
  {
    ...
    navn: 'Druen',
    type: 'Pub',
    beskrivelse: 'Koselig pub i Kvadraturen med hyggelig atmosfære og variert ølmeny.',
    antallOl: 18,
    prisKonservativ: 88,
    prisDyr: 125,
  },
  {
    ...
    navn: 'Kickoff',
    type: 'Ølbar',
    beskrivelse: 'Sportsbar og ølbar med stort utvalg og mange TV-skjermer.',
    antallOl: 30,
    prisKonservativ: 85,
    prisDyr: 120,
  },
    ...
    >
      ...
      <section style={{ maxWidth: '1200px', margin: '0 auto 2.5rem' }}>
        ...
        <p style={{ color: 'var(--text-soft)', marginTop: '0.75rem', fontSize: '1.02rem' }}>
          Oversikt over puber og barer med ølutvalg i Kristiansand sentrum.
        </p>
      </section>
