// src/pages/Trondheim.jsx
// Detaljside for Trondheim - viser utesteder med ølutvalg
import { useNavigate } from 'react-router-dom'
import olKartImg from '../assets/øl-kart.png'
import '../App.css'

// Utesteder i Trondheim - legg til flere her etterhvert
const UTESTEDER = [
  {
    id: 1,
    navn: 'Bare Blåbær',
    type: 'Pub',
    beskrivelse: 'Populær studentpub i Trondheim med godt utvalg og hyggelig atmosfære.',
    antallOl: 20,
    prisKonservativ: 88,
    prisDyr: 125,
  },
  {
    ...
    navn: 'Habitat',
    type: 'Ølbar',
    beskrivelse: 'Moderne ølbar med fokus på norske håndverksøl og sesongvarianter.',
    antallOl: 45,
    prisKonservativ: 95,
    prisDyr: 140,
  },
  {
    id: 3,
    navn: 'Bryggerikjelleren',
    type: 'Bryggeri',
    beskrivelse: 'Historisk bryggeri i Trondheim sentrum med egne øl og mat.',
    antallOl: 15,
    prisKonservativ: 92,
    prisDyr: 135,
  },
    ...
    >
      ...
      <section style={{ maxWidth: '1200px', margin: '0 auto 2.5rem' }}>
        ...
        <h1 style={{ marginTop: '1rem', fontSize: 'clamp(2rem, 3.3vw, 3.1rem)', color: 'var(--text-main)' }}>
          Utesteder i Trondheim
        </h1>
        <p style={{ color: 'var(--text-soft)', marginTop: '0.75rem', fontSize: '1.02rem' }}>
          Oversikt over puber og barer med ølutvalg i Trondheim sentrum.
        </p>
      </section>
